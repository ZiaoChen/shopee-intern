...
class LazadaSpider(scrapy.Spider):
    ...
    def parse_details(self, response):
        ...
        seller_rating = hxs.xpath(
            '//div[@class="seller-rating js-tooltip"]/@data-tooltip-header').extract_first()
        if seller_rating:
            product["seller_rating"] = float(seller_rating.split(" ")[0])
    ...
    #
    #         # Get number of reviews
    #         review = product_html.xpath('.//div[@class="c-product-card__review-num"]/text()').extract_first()
    #         if review:
    #             product['review'] = review.split(" ")[0][1]
    #
    #         # Get user rating
    ...
    #     seller = hxs.xpath('//a[@class="basic-info__name"]/text()').extract_first()
    #     if not seller:
    #         seller = hxs.xpath('//div[@class="basic-info__name"]/text()').extract_first()
    #     if seller:
    ...
    #     # Get seller rating
    #     # Format 4.1 / 5
    #     seller_rating = hxs.xpath('//div[@class="seller-rating js-tooltip"]/@data-tooltip-header').extract_first()
    #     if seller_rating:
    #         product["seller_rating"] = float(seller_rating.split(" ")[0])
    #
    #     # Get sku size and weight
